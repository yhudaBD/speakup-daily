...
**כל תשובת JSON של ה-AI עוברת סכמה** (`src/services/aiSchemas.js`, zod/mini). תשובה שלא מתאימה לסכמה
נחשבת כשל שאפשר לנסות שוב, בדיוק כמו קודי השגיאה של Groq. הסכמות מתקנות כשאפשר: פריטים לא תקינים ברשימות נזרקים,
ציונים מוגבלים ל-0–100, ורמות CEFR מחולצות מטקסט כמו "A1 (usually the lower)". הן נכשלות רק כשחסר שדה
שהפיצ'ר לא יכול לעבוד בלעדיו.
